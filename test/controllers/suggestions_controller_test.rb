...
class SuggestionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create suggestion" do
    assert_difference('Suggestion.count') do
      post suggestions_url, params: { suggestion: { image: @suggestion.image, link: @suggestion.link, post_id: @suggestion.post_id, price: @suggestion.price } }, as: :json
    end
  ...
  test "should update suggestion" do
    patch suggestion_url(@suggestion), params: { suggestion: { image: @suggestion.image, link: @suggestion.link, post_id: @suggestion.post_id, price: @suggestion.price } }, as: :json
    assert_response 200
  end
